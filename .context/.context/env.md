...
|------------|-------|---------|
| **Admin Email** | `admin@somatic-canticles.local` | Default admin account |
| **Admin Password** | `SomaticDev44!` | Default admin password |
| **Test User Email** | `test@example.com` | Regular test user |
| **Test User Password** | `TestUser13!` | Regular test user password |

**Important:**
- These credentials are seeded automatically in development
- Change these in production deployment
- Use strong, unique passwords in production
- See `.context/database/seed-dev.sql` for seed data
...
| `NEXTAUTH_SECRET` | NextAuth.js session secret | 32+ character random string |
| `NEXTAUTH_URL` | NextAuth.js canonical URL | `https://app.somatic-canticles.com` |
...
| `SENTRY_AUTH_TOKEN` | Sentry release upload token | none (CI only) |
| `METRICS_PORT` | Prometheus metrics port | `9090` |
| `NEXT_PUBLIC_GA_MEASUREMENT_ID` | Google Analytics Measurement ID | none |
