...
This is the entry point for **Somatic-Canticles Webapp**'s comprehensive documentation system. The Substrate methodology transforms your codebase into a self-documenting system optimized for both human understanding and AI consumption.

**Project context:** Somatic-Canticles is a companion experience to the manuscript—biorhythm-synced unlocks, 12 chapters in 4 cycles (physical, emotional, intellectual, spiritual), content tiers from manuscript to webapp BTS, streaks, and canticles. For vision and navigation see `.docs/00-Project-Hub/README.md` and `.docs/index.md`; for a concise project overview see [project/overview.md](./project/overview.md).
...
### Core Domains
- **[Project](./project/overview.md)** - Vision, content tiers, chapter map, power numbers; [roadmap](./project/roadmap.md) - 8-week phases
- **[Tech Stack](./tech-stack.md)** - Cloudflare-only backend, Bun, React Bits MCP for components
...
cat .context/substrate.md .context/project/overview.md .context/architecture/overview.md
